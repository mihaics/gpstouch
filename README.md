...
- gpstouch-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- gpstouch-ui: main application module, development time
- gpstouch-production: module that produces a production mode WAR for deployment
