...
@NamedQueries({
    ...
    @NamedQuery(name = "DeviceGroup.findByWorkOrderID", query = "SELECT d FROM DeviceGroup d WHERE d.workOrderID = :workOrderID")})
public class DeviceGroup implements Serializable {
    ...
    public String toString() {
        return "org.gpstouch.gts.backend.model.DeviceGroup[ deviceGroupPK=" + deviceGroupPK + " ]";
    }
