...
@NamedQueries({
    ...
    @NamedQuery(name = "Geozone.findByPriority", query = "SELECT g FROM Geozone g WHERE g.priority = :priority"),
    @NamedQuery(name = "Geozone.findBySpeedLimitKPH", query = "SELECT g FROM Geozone g WHERE g.speedLimitKPH = :speedLimitKPH"),
    ...
    @NamedQuery(name = "Geozone.findByCorridorID", query = "SELECT g FROM Geozone g WHERE g.corridorID = :corridorID"),
...
public class Geozone implements Serializable {
    ...
    @Lob
    @Size(max = 65535)
    @Column(name = "corrStartSelector")
    private String corrStartSelector;
    @Lob
    @Size(max = 65535)
    @Column(name = "corrEndSelector")
    private String corrEndSelector;
    ...
    public String getCorrStartSelector() {
        return corrStartSelector;
    }

    public void setCorrStartSelector(String corrStartSelector) {
        this.corrStartSelector = corrStartSelector;
    }

    public String getCorrEndSelector() {
        return corrEndSelector;
    }

    public void setCorrEndSelector(String corrEndSelector) {
        this.corrEndSelector = corrEndSelector;
    }
    ...
    public String toString() {
        return "org.gpstouch.gts.backend.model.Geozone[ geozonePK=" + geozonePK + " ]";
    }
